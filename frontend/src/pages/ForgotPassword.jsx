...
export default function ForgotPassword() {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      const res = await axios.post('https://auth-system-pf8e.vercel.app/api/auth/forgot-password', { email });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const res = await axios.post('https://auth-system-pf8e.vercel.app/api/auth/reset-password', {
        email,
        otp,
        newPassword,
      });
